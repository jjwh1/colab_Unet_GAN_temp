...
def main():
    ...
    checkpoint_path = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/AOT_GAN_lr_00010001_beta_paper_fold1_colab/db1_train/checkpoint_epoch_90.tar"  # 불러올 시 마지막 저장된 pth파일 경로 입력!!
