...
def load_checkpoint(checkpoint_path, generator, discriminator, optimizer_g, optimizer_d):
    ...
    return generator, discriminator, optimizer_g, optimizer_d, epoch, g_loss, g_l2_loss, d_loss
...
def main():
    ...
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/AOT_GAN_lr_00010001_beta_paper_fold2_colab/db2_train"
    ...
    checkpoint_path = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/AOT_GAN_lr_00010001_beta_paper_fold2_colab/db2_train/checkpoint_epoch_89.tar"  # 불러올 시 마지막 저장된 pth파일 경로 입력!!
