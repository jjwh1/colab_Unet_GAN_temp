...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/Blind_lr_0001_L1loss0.5_fold2_colab/db2_train"
    ...
    # Models and losses
    generator = Inpainting().to(device)


    # Optimizers
    # optimizer_g = optim.Adam(generator.parameters(), lr=lr_g, betas=(0.5, 0.999))
    optimizer_g = optim.AdamW(generator.parameters(), lr=lr_g, weight_decay=1e-4)
