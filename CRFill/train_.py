...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/CRFill_lr_00010001_fold1_colab/db1_train"
    ...
    checkpoint_path = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/CRFill_lr_00010001_fold1_colab/db1_train/checkpoint_epoch_227.tar"  # 불러올 시 마지막 저장된 pth파일 경로 입력!!
