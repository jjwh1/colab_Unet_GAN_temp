...
# https://github.com/nipponjo/deepfillv2-pytorch/blob/master/model/losses.py   참고
# ----------------------------------------------------------------------------
...
class GatedGenerator(nn.Module):
    ...
    def __init__(self, cnum_in=4, cnum_out=3, cnum=48,
    ...
    def forward(self, x, largemask):   # x: concat 4채널
        """
        Args:
        ...
        x = x_stage1 * largemask + xin[:, :3] * (1. - largemask)
        # get refined result
        x_stage2 = self.stage2(x, largemask)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, cnum_in=4, cnum=64):
        super().__init__()
    ...
    def forward(self, x, mask):   # x: 3채널 이미지(복원된거 혹은 gt)
