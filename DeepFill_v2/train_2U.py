...
def main():
    ...
    checkpoint_path = "/content/drive/MyDrive/inpaint_result/UPOL/DeepFillv2_lr_00010001_fold2_colab_re/db2_train/checkpoint_epoch_299.tar"  # 불러올 시 마지막 저장된 pth파일 경로 입력!!
