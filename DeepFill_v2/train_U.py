...
def train_gan_epoch(generator, discriminator, dataloader, optimizer_g, optimizer_d, device):  # 한 에포크 학습 정의
    generator.train()
    discriminator.train()
...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/UPOL/DeepFillv2_lr_00010001_fold1_colab_re/db1_train"
    ...
    checkpoint_path = "/content/drive/MyDrive/inpaint_result/UPOL/DeepFillv2_lr_00010001_fold1_colab_re/db1_train/checkpoint_epoch_300.tar"  # 불러올 시 마지막 저장된 pth파일 경로 입력!!
