...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/hyper_ablation_0.1_0.1_0.1/db2_train"
    # save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/hyper_ablation_1_0.1_0.1/db2_train"
    # save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/hyper_ablation_0.1_1_0.1/db2_train"
