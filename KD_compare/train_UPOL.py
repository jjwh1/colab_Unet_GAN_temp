...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/UPOL/MSA_nodil_1024_4B_Unet_GAN_add_L2_largemask_hole_loss_100_recogL2lossfold1_0.1_colab_batch4/db1_train"
    ...
    MODEL_PATH = MODEL_PATH = "/content/dataset/recog1_saved_model_epoch.pth"
