...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/UPOL/KD_Fitnets_Lendecoder_ADx_en1de1_L2_total_5__S_4pool_T_nodil4B1024_fold1_colab/db1_train"
    ...
    teacher_paths = '/content/dataset/UPOL_recog_T_pth/T1_checkpoint_epoch.tar'
    

    results_path = os.path.join(save_dir, "metrics.csv")

    # [추가] Feature L1 Loss를 위한 ConvNeXt 모델 로드
    MODEL_PATH = "/content/dataset/UPOL_recog_T_pth/recog1_saved_model_epoch.pth"
    ...
    adaptor_enc3 = adaptors.Fitnets(128,256).to(device)
    adaptor_bottleneck = adaptors.Fitnets(256,1024).to(device)
    
    adaptor_dec3 = adaptors.Fitnets(128,256).to(device)
