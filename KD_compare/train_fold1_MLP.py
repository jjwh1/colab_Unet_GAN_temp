...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/UPOL/KD_MLP_Lendecoder_ADx_en1de1_L2_total_5__S_4pool_T_nodil4B1024_fold1_colab/db1_train"
    ...
    adaptor_enc3 = adaptors.MLP(128,256).to(device)
    adaptor_bottleneck = adaptors.MLP(256,1024).to(device)
    
    adaptor_dec3 = adaptors.MLP(128,256).to(device)
