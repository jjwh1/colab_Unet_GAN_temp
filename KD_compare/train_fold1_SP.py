...
def train_gan_epoch(generator, generator_T, discriminator,adaptor_enc3,adaptor_bottleneck,adaptor_dec3,dataloader, criterion, optimizer_g, optimizer_d, device, recognition_model, lambda_adv=0.1):  # 한 에포크 학습 정의
    ...
    for inputs, gts, masks, _ ,_ ,largemasks in progress_bar:
        ...
        kd_loss_enc3 = adaptor_enc3(teacher_enc3, student_enc3)
     
        kd_loss_bottleneck = adaptor_bottleneck(teacher_bottleneck,student_bottleneck)
        kd_loss_dec1 = nn.MSELoss()(student_dec1, teacher_dec1)
    
        kd_loss_dec3 = adaptor_dec3(teacher_dec3, student_dec3)
...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/UPOL/KD_SP_Lendecoder_ADx_en1de1_L2_total_5__S_4pool_T_nodil4B1024_fold1_colab/db1_train"
