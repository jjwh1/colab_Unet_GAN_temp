...
def main():
    # Paths
    save_dir = "/scratch/x3112a05/JWH/result/CASIA_Lamp/ab_KD_PCatt_SRx_Lendecoder_ADx_en1de1_L2_total_5__S_4pool_T_nodil4B1024_fold1_kisti/db1_train"
    writer = SummaryWriter(os.path.join(save_dir, 'SR_Stage_4%s' % datetime.now().strftime("%Y%m%d-%H%M%S")))

    train_image_paths = '/scratch/x3112a05/JWH/dataset/CASIA_Iris_Lamp/reflection_random(50to1.7)_db1_224_trainset'  # List of input image paths
    train_mask_paths = '/scratch/x3112a05/JWH/dataset/mask/CASIA_Lamp/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db1_test_layer12_0.3_only_mask_trainset'  # List of mask paths
    train_gt_paths = "/scratch/x3112a05/JWH/dataset/CASIA_Iris_Lamp/db1_224_for_gt_inpainting_trainset"  # List of ground truth paths
    train_large_mask_paths = "/scratch/x3112a05/JWH/dataset/mask/CASIA_Lamp/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db1_test_layer12_0.3_only_mask_h2.8_w3_trainset"  # List of ground truth paths

    val_image_paths = '/scratch/x3112a05/JWH/dataset/CASIA_Iris_Lamp/reflection_random(50to1.7)_db1_224_validset'  # List of input image paths
    val_mask_paths = '/scratch/x3112a05/JWH/dataset/mask/CASIA_Lamp/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db1_test_layer12_0.3_only_mask_validset'  # List of mask paths
    val_gt_paths = "/scratch/x3112a05/JWH/dataset/CASIA_Iris_Lamp/db1_224_for_gt_inpainting_validset"  # List of ground truth paths
    val_large_mask_paths = "/scratch/x3112a05/JWH/dataset/mask/CASIA_Lamp/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db1_test_layer12_0.3_only_mask_h2.8_w3_validset"  # List of ground truth paths

    teacher_paths = '/scratch/x3112a05/JWH/teacher_weight/CASIA_Lamp/db1_train_checkpoint_epoch_400.tar'

    results_path = os.path.join(save_dir, "metrics.csv")

    # [추가] Feature L1 Loss를 위한 ConvNeXt 모델 로드
    MODEL_PATH = "/scratch/x3112a05/JWH/dataset/recognition_path/CASIA_Lamp/saved_model_epoch_100_db1.pth"
