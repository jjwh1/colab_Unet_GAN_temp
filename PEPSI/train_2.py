...
from models import PepsiNet, Discriminator
...
def main():
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/PEPSI_lr_00010004_fold2_colab/db2_train"
