...
def main():
    save_dir = r"D:\inpaint_result\CASIA_Distance\TT_GAN_fold2_py/db2_train"

    writer = SummaryWriter(os.path.join(save_dir, 'SR_Stage_4%s' % datetime.now().strftime("%Y%m%d-%H%M%S")))
    # Paths
    train_image_paths = r"C:\Users\8138\Desktop\DB\CASIAv4\CASIA_Ver4_Distance\reflection_random(50to1.7)_db2_224_trainset"  # List of input image paths
    train_mask_paths = 'D:/mask/CASIA_Distance/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db2_test_layer12_0.3_only_mask_trainset'  # List of mask paths
    train_gt_paths = r"C:\Users\8138\Desktop\DB\CASIAv4\CASIA_Ver4_Distance\db2_224_for_gt_inpainting_trainset"  # List of ground truth paths
    train_large_mask_dir = "D:/mask/CASIA_Distance/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db2_test_layer12_0.3_only_mask_h2.8_w3_trainset"  # List of ground truth paths

    val_image_paths = r"C:\Users\8138\Desktop\DB\CASIAv4\CASIA_Ver4_Distance\reflection_random(50to1.7)_db2_224_validset"  # List of input image paths
    val_mask_paths = 'D:/mask/CASIA_Distance/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db2_test_layer12_0.3_only_mask_validset'  # List of mask paths
    val_gt_paths = r"C:\Users\8138\Desktop\DB\CASIAv4\CASIA_Ver4_Distance\db2_224_for_gt_inpainting_validset"  # List of ground truth paths
    val_large_mask_dir = "D:/mask/CASIA_Distance/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db2_test_layer12_0.3_only_mask_h2.8_w3_validset"  # List of large_mask paths
