...
def main():
    ...
    # Paths
    save_dir = "/content/drive/MyDrive/inpaint_result/UPOL/VCNet_lr_0000100001_L1_0.8_noSEMTEXloss_beta_paper_fold2_colab/db2_train"
    ...
    # checkpoint_path = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/VCNet_lr_0000100001_L1_0.8_noSEMTEXloss_beta_paper_fold2_colab_re/db2_train/checkpoint_epoch_133.tar"  # 불러올 시 마지막 저장된 pth파일 경로 입력!!
