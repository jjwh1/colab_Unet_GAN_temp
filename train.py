...
def main():
    ...
    save_dir = "/content/drive/MyDrive/inpaint_result/CASIA_Lamp/Unet_GAN_temp_epoch400_pixelLoss10_batch8_colab/db1_train"
    ...
    train_large_mask_paths = "/content/dataset/mask/CASIA_Lamp/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db1_test_layer28_0.3_only_mask_large_mask_h2.6_w2.8_trainset"  # List of ground truth paths
    ...
    val_large_mask_paths = "/content/dataset/mask/CASIA_Lamp/algorithm/450to50000_174x174padding_if_gac1_4000_algorithm/db1_test_layer28_0.3_only_mask_large_mask_h2.6_w2.8_validset"  # List of ground truth paths
